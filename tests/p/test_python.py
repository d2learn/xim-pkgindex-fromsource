...
class TestIsolation:
    ...
    @pytest.mark.isolation
    @pytest.mark.xfail(reason="python 当前使用 LD_LIBRARY_PATH, 待迁移到 elfpatch RPATH")
    ...
    @pytest.mark.isolation
    @pytest.mark.xfail(reason="python 使用旧 API, 待迁移到 xim.libxpkg.*")
...
class TestVerify:
    ...
    def test_version(self):
        assert_command_output("python3 --version", contains="Python")
