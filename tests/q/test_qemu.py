...
class TestIsolation:
    ...
    @pytest.mark.isolation
    @pytest.mark.xfail(reason="qemu 当前直接调用系统包管理器安装构建依赖, 待迁移到 deps 声明")
...
class TestVerify:
    ...
    def test_version(self):
        assert_command_output("qemu-system-x86_64 --version 2>&1 | head -1", contains="QEMU")
